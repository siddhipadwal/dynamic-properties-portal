...
function ContactFormModal({ isOpen, onClose, propertyName }) {
  ...
  const validatePhone = (phone) => {
    ...
    if (!phoneRegex.test(phone)) {
      return 'Looks like the number is incorrect. Please enter your correct 10-digit mobile number.';
    }
    return '';
  };
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input 
                ...
                maxLength={10}
                required
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#B39359] outline-none" 
                ...
                <div className="relative overflow-hidden cursor-pointer" onClick={() => setIsGalleryOpen(true)}>
                  ...
                  <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-all duration-300 flex items-center justify-center">
                    <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      <svg className="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M21 21l-6-6m2-5a7 7 14 0 0 11-7 7 0 0114 0zM10 7v3m0 0v3m0-3h3m-3 0H7" /></svg>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-gradient-to-r from-[#03333B] to-[#055661] rounded-2xl p-6 sm:p-8 text-center relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 justify-center">
                    ...
                    <a href="tel:+917317241999" className="bg-white/10 text-white px-6 py-3 rounded-xl font-semibold border border-white/30 hover:bg-white hover:text-[#03333B] transition-all duration-300 hover:scale-105 hover:shadow-lg inline-flex items-center justify-center gap-2">
                ...
                <div className="flex gap-2 mt-4 overflow-x-auto pb-2 justify-center">
                  {galleryImages.map((img, index) => (
                    <button
                      ...
                      className={`flex-shrink-0 w-16 h-12 sm:h-14 rounded overflow-hidden transition-all duration-300 sm:w-20 ${activeImageIndex === index ? 'ring-2 ring-[#B39359] ring-offset-2' : 'opacity-60 hover:opacity-100'}`}
                    >
