...
export default function UnderConstructionPage() {
  ...
  const fetchProperties = async () => {
    try {
      ...
      if (response.ok) {
        // Filter only Under Construction properties and apply localStorage order
        const underConstruction = data.properties.filter(
          p => p.status === 'Under Construction'
        );
        const sortedProperties = sortPropertiesByOrder(underConstruction);
          ...
          ">
            ...
            "> 
              ...
              <span className="font-sans text-center break-words">
                Browse premium properties currently under development
              </span>
            </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center max-w-2xl mx-auto mb-12 sm:mb-14">
            ...
            <p className="font-karla text-gray-600 text-base sm:text-lg">
              Invest in properties under construction with high appreciation potential
            </p>
          </div>
          ...
          {loading ? (
            ...
            <div className="text-center py-16 sm:py-20">
              <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-gray-100 mb-4">
                <i className="fas fa-hard-hat text-gray-400 text-3xl"></i>
              </div>
